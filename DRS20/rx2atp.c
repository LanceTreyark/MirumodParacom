...
const char version[] PROGMEM = "0.20 20130720";
...
void dr_loop(void)
{
	...
	while (1) {
		...
		if (s < 3) rx_read();
			...
			/* Arduino LED blink */
#if	0	/* set to 1 to turn off LED when airborne */
			if (s == 10) LEDOF(); else
#endif
			if (led == 0) LEDTG();
			else if ((led >>= 1) == 0) {
...
#define	RX_CON	1	/* 0 if RX-THRO is on D7, 1 if RX-THRO on D2 */
#if	RX_CON == 0
...
asm(" .word  11672"); /* size */
asm(" .word 0xb8ca"); /* checksum */
asm(" .byte 31,139,8,0,149,184,234,81,2,3,237,124,123,124,84,69");
...
asm(" .byte 80,212,130,34,85,41,82,113,44,93,80,164,178,165,179,81");
asm(" .byte 170,125,227,140,73,244,113,45,107,73,205,50,150,96,73,146");
asm(" .byte 198,73,105,150,12,105,178,52,197,156,41,77,149,178,76,249");
asm(" .byte 210,138,242,242,82,101,86,117,219,214,246,70,87,251,118,101");
asm(" .byte 197,156,57,202,234,102,143,139,100,169,5,234,109,115,75,212");
asm(" .byte 91,149,226,130,146,2,27,166,190,99,51,125,216,204,217,192");
asm(" .byte 10,154,91,61,174,118,55,43,104,109,243,184,10,150,150,173");
asm(" .byte 154,235,113,110,98,5,155,157,29,155,89,65,211,246,214,142");
asm(" .byte 237,91,244,212,211,206,10,54,181,110,45,16,71,156,235,50");
asm(" .byte 117,40,107,119,181,16,159,142,184,91,60,36,185,25,255,122");
asm(" .byte 92,56,11,21,108,68,6,69,109,116,36,100,5,75,171,214");
asm(" .byte 20,128,76,205,235,104,115,211,54,157,191,206,217,222,238,220");
asm(" .byte 174,243,143,224,247,54,182,107,42,56,183,52,55,162,217,54");
asm(" .byte 136,211,197,52,224,132,167,9,160,143,164,53,55,108,245,184");
asm(" .byte 144,111,108,219,178,197,213,234,249,111,216,196,120,97,255,100");
asm(" .byte 147,218,247,42,37,221,238,110,252,6,99,186,248,174,35,241");
asm(" .byte 105,223,149,148,244,239,157,25,191,199,200,196,247,31,173,130");
asm(" .byte 143,214,198,102,240,93,48,148,143,172,155,175,139,182,77,98");
asm(" .byte 205,216,129,168,38,189,174,196,198,190,55,89,40,214,141,73");
asm(" .byte 172,49,183,69,95,91,55,234,183,128,233,235,131,248,104,109");
asm(" .byte 92,131,160,229,134,118,77,2,42,196,122,210,218,197,154,178");
asm(" .byte 99,209,214,11,157,205,6,254,106,241,93,72,147,88,147,193");
asm(" .byte 4,125,45,90,110,248,254,100,173,129,143,214,240,145,4,125");
asm(" .byte 109,91,68,255,70,248,92,66,215,4,225,99,130,137,186,191");
asm(" .byte 185,113,252,234,13,124,218,122,1,223,30,233,122,62,130,251");
asm(" .byte 12,124,218,183,76,161,132,125,254,23,229,125,219,192,71,62");
asm(" .byte 205,179,100,236,187,153,70,190,7,12,118,176,3,124,59,192");
asm(" .byte 87,155,240,69,190,157,6,190,11,167,0,203,24,171,249,18");
asm(" .byte 121,143,232,124,238,46,38,190,163,186,92,255,86,102,202,13");
asm(" .byte 124,63,16,223,224,52,179,145,239,157,142,149,25,249,14,139");
asm(" .byte 239,135,154,133,15,182,252,25,190,255,41,244,35,62,250,70");
asm(" .byte 88,210,159,225,123,86,140,137,153,141,124,71,117,236,27,174");
asm(" .byte 198,249,253,165,65,30,249,238,148,74,198,246,177,47,206,71");
asm(" .byte 200,192,119,16,124,7,43,245,181,112,99,187,167,133,92,226");
asm(" .byte 163,239,157,189,8,190,225,91,191,200,247,27,157,199,61,66");
asm(" .byte 39,190,57,95,178,46,127,47,112,85,228,7,193,55,251,6");
asm(" .byte 62,201,160,219,232,183,44,171,24,27,248,146,111,173,254,111");
asm(" .byte 76,125,139,207,48,87,0,0");
asm("eod_flash_pgb:");
